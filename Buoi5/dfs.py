...
class PuzzleGUI:
    ...
    def create_widgets(self):
        # Title
        title_label = tk.Label(self.root, text="8-Puzzle DFS Solver", font=("Arial", 16, "bold"))
    ...
    def solve_puzzle(self):
        self.solution = dfs(start, goal, set(), [], 20)
        ...
        if self.solution:
            ...
            messagebox.showerror("Error", "No solution found within depth limit!")
